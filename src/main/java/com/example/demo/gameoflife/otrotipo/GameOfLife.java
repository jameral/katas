package com.example.demo.gameoflife.otrotipo;

import com.example.demo.gameoflife.Celda;
...
public class GameOfLife {
    ...
    public String toString(){
        ...
        sb.append(columnCount).append("   ").append(rowCount).append("\n");
        for (int i= rowCount-1;i>=0;i--){
            for (int j=0;j<=columnCount-1;j++){

                sb.append(grid[i][j] == LIVING_CELL ? "*" : ".");
            }
            sb.append("\n");
        }
        return sb.toString();
